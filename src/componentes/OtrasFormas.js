...
export default function ContactUs() {
    ...
    emailjs.sendForm('paginaDeRaices', 'template_b28a33g', e.target, 'user_74xNSkjScfhNS3fENKv46')
        .then((result) => {
            ...
            <form onSubmit={sendEmail}>
                    <div className="row pt-5 mx-auto">
                        ...
                        <div className="col-8 form-group pt-2 mx-auto">
                            <input type="email" className="form-control" placeholder="Direccion de Email" name="email"/>
                        </div>
                        <div className="col-8 form-group pt-2 mx-auto"> <b>Selecciona opcion a colaborar</b> <br/>
